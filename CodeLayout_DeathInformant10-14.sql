...
DECLARE @TargetTable VARCHAR(128) = 'DeathInformant',  -- replace this 
        @StandardFilter VARCHAR(1024)= '
					  ...
					  AND D.FL_VOIDED  = 0 
					  ',
	@TestFilter VARCHAR (MAX) = ''    --test here:    @TestFilter VARCHAR (MAX) = ' AND internal_case_number= 201940053907'
...
DECLARE        
		...
		@cfc int,@mfc int,
		@top VARCHAR(128) =  'TOP 10000000 ',  -- For PROD leave this blank 
...
INSERT INTO #validation (columnname , condition , errormessage,errortype) values 
						 ...
						 ('InformantRelation,OtherInformantRelation','OtherInformantRelation != ''NULL'' AND InformantRelation !=''OTHER'''  ,   'When Other is not blank relation should be Other',  'Error')
...
insert into  #dc  (SourceColumn,TableName,ColumName, ObjectType,DataType, DC, OtherFilter, DCType) values --DCType = OtherOnly, StandardOnly, Standard&Other
  ...
  ('InformantRelation','DimInformantRelation', 'DimInformantRelationId', 'Dim', 'INT',1, ' AND MT.OtherInformantRelation = DC.FilterValue AND DC.Mapping_Previous = ''OTHER''', 'OtherOnly'),
