...
DECLARE @TargetTable VARCHAR(128) = 'VeteranOtherAtr',  -- replace this 
...
('ARMED', 1,'','','Armed','VARCHAR(12)', NULL, '''NULL'''),
('VET_ENTRIES',1,'','','VeteranEntries', 'INT',NULL, NULL),
('VET1_WAR',1,'','','WAR1', 'VARCHAR(128)',NULL, NULL),
('VET2_WAR',1,'','','WAR2', 'VARCHAR(128)', NULL, NULL),
('VET3_WAR',1,'','','WAR3', 'VARCHAR(128)', NULL,NULL )
...
INSERT INTO #validation (columnname , condition , errormessage,errortype) values 
						 ('VeteranEntries','VeteranEntries>3' ,   'Not a valid Veteran Entry',  'Error'),
						 ('VeteranEntries','VeteranEntries = 0 AND (WAR1 IS NOT NULL OR WAR2 IS NOT NULL OR WAR3 IS NOT NULL)',   'Veteran Entry and War Entered Mismatch',  'Warning'),
						 ('VeteranEntries','VeteranEntries = 1 AND (WAR1 IS NULL OR WAR2 IS NOT NULL OR WAR3 IS NOT NULL)',   'Veteran Entry and War Entered Mismatch',  'Warning'),
						 ('VeteranEntries','VeteranEntries = 2 AND (WAR1 IS NULL OR WAR2 IS NULL OR WAR3 IS NOT NULL)',   'Veteran Entry and War Entered Mismatch',  'Warning'),
						 ('VeteranEntries','VeteranEntries = 3 AND (WAR1 IS NULL OR WAR2 IS NULL OR WAR3 IS  NULL)',   'Veteran Entry and War Entered Mismatch',  'Warning')
