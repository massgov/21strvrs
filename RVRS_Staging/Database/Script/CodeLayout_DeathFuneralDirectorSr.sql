...
DECLARE @TargetTable VARCHAR(128) = 'DeathFuneralDirector',  -- replace this 
...
('FDIR_FRST_NME',1,'','','FirstName', 'VARCHAR(128)',NULL,NULL),
('FDIR_MIDD_NME',1,'','','MiddleName', 'VARCHAR(128)',NULL,NULL),
('FDIR_LST_NME',1,'','','LastName', 'VARCHAR(128)',NULL,NULL),
('FDIR_LST_NME',1,'','','LastName_Suffix', 'VARCHAR(128)',NULL,NULL),			--checking Suffix in lastname
('FDIR_SUFFIX',1,'','','Suffix', 'VARCHAR(128)',NULL,'''NULL'''),
('FDIR_LIC_NUM',1,'','','LicenseNumber', 'VARCHAR(128)',NULL,NULL)

--('FNRL_SERVICE_OOS',1,'','','FNRL_SERVICE_OOS', 'VARCHAR(128)',1,'''NULL'''),
--('TRADE_FH_UNLISTED',1,'','','TRADE_FH_UNLISTED', 'VARCHAR(128)',1,'''NULL'''),
--('FL_FUNERAL_HOME_UNLISTED',1,'','','FL_FUNERAL_HOME_UNLISTED', 'VARCHAR(128)',1,'''NULL'''),
--('FNRL_NME',1,'','','FNRL_NME', 'VARCHAR(128)',1,'''NULL'''),
--('FH_NAME',1,'','','FH_NAME', 'VARCHAR(128)',1,'''NULL'''),
--('FNRL_NME',1,'','','FNRL_NME', 'VARCHAR(128)',1,'''NULL'''),
--('FH_RESPONSIBLE_NAME',1,'','','FH_RESPONSIBLE_NAME', 'VARCHAR(128)',1,'''NULL'''),
--('1',1,'','','DimFuneralHomeTypeInternalId', 'VARCHAR(128)',1,'''NULL'''),
...
insert into  #dc  (SourceColumn,TableName,ColumName,DimColumn, ObjectType,DataType, DC, OtherFilter, DCType,DCTableName,DimFilter) values --DCType = OtherOnly, StandardOnly, Standard&Other
	...
	('FirstName','DeathFuneralDirector_FirstName', 'FirstName','', 'FACT', 'VARCHAR(128)',1, NULL, NULL,'[RVRS].[Data_Conversion]',NULL),
	('MiddleName','DeathFuneralDirector_MiddleName', 'MiddleName','', 'FACT', 'VARCHAR(128)',1, NULL, NULL,'[RVRS].[Data_Conversion]',NULL),
	('LastName','DeathFuneralDirector_LastName', 'LastName','', 'FACT', 'VARCHAR(128)',1, NULL, NULL,'[RVRS].[Data_Conversion]',NULL),
	('LicenseNumber','DeathFuneralDirector_LicenseNumber', 'LicenseNumber','', 'FACT', 'VARCHAR(128)',1,NULL,NULL,'[RVRS].[Data_Conversion]',NULL),
	('Suffix','DimSuffix', 'DimSuffixId','SuffixDesc', 'Dim', 'INT',1, NULL, NULL,'[RVRS].[Data_Conversion]',NULL),
	('LastName_Suffix','DimSuffix_LastName', 'DimSuffixId','SuffixDesc', 'CONV_DIM', 'VARCHAR(128)',1, NULL, NULL,'[RVRS].[Data_Conversion]',NULL)
	...
	BEGIN 
      ...
      IF @DC = 1
		...
		IF @DCType  LIKE '%Standard%' OR @DCType IS NULL
			PRINT  '  			
			UPDATE MT
				SET ' + IIF (@ObjectType IN ('Dim','CONV_DIM') , ' MT.' + @ColumnName +'=DC.Mapping_Current_ID,', '') + '
