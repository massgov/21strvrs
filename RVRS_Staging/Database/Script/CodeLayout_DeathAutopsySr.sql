...
DECLARE @TargetTable VARCHAR(128) = 'DeathAutopsy',  -- replace this 
...
('ME_CR_CONT', 1,'','','MedicalExaminerContacted','VARCHAR(128)', NULL,'''NULL'''),
('AUTOPSY', 1,'','','AutopsyPerformed','VARCHAR(128)', NULL,'''NULL'''),
('AUTOPSY_F_AVAIL', 1,'','','FindingAvailable','VARCHAR(128)', NULL,'''NULL''')
...
insert into  #dc  (SourceColumn,TableName,ColumName,DimColumn, ObjectType,DataType, DC, OtherFilter, DCType) values --DCType = OtherOnly, StandardOnly, Standard&Other
	...
	('MedicalExaminerContacted','DimYesNo', 'DimMedicalExaminerContactedId','Abbr', 'Dim', 'INT',0, NULL, NULL),
	('AutopsyPerformed','DimAutopsyPerformed', 'DimAutopsyPerformedId','Abbr', 'Dim', 'INT',0, NULL, NULL),
	('FindingAvailable','DimYesNo', 'DimFindingAvailableId','Abbr', 'Dim', 'INT',0, NULL, NULL)
