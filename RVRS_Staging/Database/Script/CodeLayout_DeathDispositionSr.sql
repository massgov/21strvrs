/*
  ...
  Note: Join Logic Added in line number 406
*/

SET NOCOUNT ON
USE RVRS_STAGING

DECLARE @TargetTable VARCHAR(128) = 'DeathDisposition',  -- replace this 
...
('DISP',1,'','','DispMethod', 'VARCHAR(128)',NULL,'''NULL'''),
('DISPL',1,'','','OtherDispMethod', 'VARCHAR(128)',NULL,'''NULL'''),
('DISP_DATE',1,'','','DISP_DATE', 'VARCHAR(128)',NULL,NULL),
('RIGHT(DISP_DATE,4)',1,'','','DispYear', 'VARCHAR(128)', NULL,NULL ),
('LEFT(DISP_DATE,2)',1,'','','DispMonth', 'VARCHAR(128)', NULL,NULL ),
('SUBSTRING(DISP_DATE,4,2)',1,'','','DispDay', 'VARCHAR(128)', NULL,NULL ),
('DISP_NME',1,'','','DispPlace', 'VARCHAR(128)',NULL,'''NULL'''),
('IND_PB_STATUS',1,'','','PermitStatus', 'VARCHAR(128)',NULL,NULL),
('CREM_CEM_UNLISTED',1,'','','CREM_CEM_UNLISTED', 'VARCHAR(128)',NULL,NULL),
('DOD_4_FD',1,'','','DOD_4_FD', 'VARCHAR(128)',NULL,NULL),
('CEM_NAME',1,'','','CEM_NAME', 'VARCHAR(128)',NULL,NULL)
...
--If TRADE_FH_UNLISTED =  'N' OR FL_FUNERAL_HOME_UNLISTED = 'N' and  FNRL_NME <> FH NAME In VT_Funeral_Home ,  log warning and save ASIS 
						...
						('DimDispMethodId,DimOtherDispMethodId','(DispMethod != ''O'' AND OtherDispMethod != ''NULL'')','Value in Disposition Method and Disposition Other Method is not aligned',  'Error'),	
