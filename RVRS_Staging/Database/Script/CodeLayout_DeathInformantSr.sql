...
DECLARE        
  ...
  DECLARE     @Workdb VARCHAR(128) = '',  -- For PROD leave this blank or set to @stagingdb
		@rc INT = 0,
...
INSERT INTO #validation (columnname , condition , errormessage,errortype) values 
						 ...
						 ('RelationList,InformantRelation','(InformantRelation=''HUSBAND'' AND RelationList <> 1) OR (InformantRelation=''WIFE'' AND RelationList <> 2) OR
						 ...
						 OR (InformantRelation IS NULL AND RelationList  IS NOT NULL)',   'Mismatch between code and relation',  'Error')						
