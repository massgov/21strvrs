...
--select * from [RVRS].[DeathRegistration]
--
SET ANSI_NULLS ON
GO
 --use RVRS_testdb
...
IF NOT EXISTS (SELECT 1 FROM sys.Objects 
	...
	BEGIN
		CREATE TABLE[RVRS].[DeathRegistration](  		
			...
			[DimRegistrarTypeInternalId] INT NOT NULL CONSTRAINT [df_DeathRegistrationDimRegistrarTypeInternalId] DEFAULT (0), --OCCURRENCE, RESIDENCE,STATE
			[PersonId] BIGINT NOT NULL,  --  RVRS Column 
			[RegistrationDate]  VARCHAR(10) NULL, --  RESIDE_REGIS_DATE, OCCUR_REGIS_DATE,ST_REGIS_DATE
			...
			[RegistrationNumber]  VARCHAR(32) NULL, -- RECORD_REGIS_NUM,OCCUR_REGIS_NUM,RESIDE_REGIS_NUM,ST_REGIS_NUM
			...
			[RegVolume]  VARCHAR(24) NULL, -- OCCUR_REGIS_VOLUME,RESIDE_REGIS_VOLUME,ST_VOLUME
			[RegPage]  VARCHAR(10) NULL, -- OCCUR_REGIS_PAGE,RESIDE_REGIS_PAGE,ST_PAGE
			...
			[FlArchived] VARCHAR(8) NULL, -- FL_OCCUR_ARCHIVED,FL_RES_ARCHIVED,FL_RVRS_ARCHIVED		
			[FlAcknowledge] VARCHAR(8)  NULL, -- RESIDE_AMEND_ACKNOWLEDGE_FL 				
			...
			[FlRegistered]  VARCHAR(8), -- OCCUR_REGISTERED_FL,RESIDE_REGISTERED_FL,STATE_REGISTERED_FL			
			[SrcRegistererUserId]  INT  NULL, -- REGISTERER_ID(Occur),REGISTERER_ID_RE(Res), REGISTERER_ID_ST			
			[FlSearchable] VARCHAR(8)  NULL, -- FL_SEARCHABLE,FL_SEARCHABLE_RVRS,FL_SEARCHABLE_RESIDE
